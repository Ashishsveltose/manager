          ...
          <form method="post">
					<div class="card-body">
						...
						<div class="form-group mb-3">
							...
							<input type="email" class="form-control"   name="email" placeholder="Email"value="<?php echo (!empty($customer_data) && !empty($customer_data['email']) ? $customer_data['email'] : "" )?>" >
						</div>
						<div class="form-group mb-3">
							<label class="floating-label" for="Email">Otp</label>
							<input type="text" class="form-control" name="otp" placeholder="otp" value="<?php echo (!empty($customer_data) && !empty($customer_data['otp']) ? $customer_data['otp'] : "" )?>"    placeholder="Otp" >
						</div>
					
						
					<button class="btn btn-block btn-primary mb-4" type="submit" name="login" value="login">Submit</button>
