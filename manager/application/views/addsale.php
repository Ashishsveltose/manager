                                    ...
                                    <form role="form" enctype="multipart/form-data" method="post" action="">
                                        <div class="row m-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label> name</label>
                                                    <input class="form-control" type="text" placeholder="username" value="<?php if(!empty($tax_data['username'])){echo $tax_data['username'];}else{echo '';}?>" name="username"/>
                                                </div>
                                            </div>
                                           <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>Email</label>
                                                    <input class="form-control" type="text" placeholder="email" value="<?php if(!empty($tax_data['email'])){echo $tax_data['email'];}else{echo '';}?>" name="email"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="mobile_no" value="<?php if(!empty($tax_data['mobile_no'])){echo $tax_data['mobile_no'];}else{echo '';}?>" name="mobile_no"/>
                                                </div>
                                            </div>
                                           <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>Password</label>
                                                    <input class="form-control" type="text" placeholder="password" value="<?php if(!empty($tax_data['password'])){echo $tax_data['password'];}else{echo '';}?>" name="password"/>
                                                </div>
                                            </div>
                                        </div>
