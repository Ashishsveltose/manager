                ...
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-textarea-resize"></span><span class="mtext">UserList</span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li class="dropdown">
                        <a href="adminrole-manger.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-textarea-resize"></span><span class="mtext">Admin User Role</span>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-archive"></span><span class="mtext"> Service</span>
                        </a>
                        <ul class="submenu">
                            <li><a href="seller-service.html">Seller Service</a></li>
                            <li><a href="admin-service.html">Admin Service </a></li>
                        </ul>
                    </li>

                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-hdd-stack"></span><span class="mtext">Refer & Earn </span>
                        </a>
                        <ul class="submenu">
                            <li><a href="sendRequest.html">Send Request</a></li>
                            <li><a href="refer-list.html">Refer List</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="wallet.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-table"></span><span class="mtext">Wallet</span>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-archive"></span><span class="mtext"> Category</span>
                        </a>
                        <ul class="submenu">
                            <li><a href="category.html">Category</a></li>
                            <li><a href="subCategory.html">Sub Category</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-archive"></span><span class="mtext">Area</span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li class="dropdown">
                        <a href="payout-request.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-hdd-stack"></span><span class="mtext">Payout Request</span>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a href="service-reviews.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-hdd-stack"></span><span class="mtext">Review</span>
                        </a>
                    </li>

                    <li class="dropdown">
                        <a href="job.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-table"></span><span class="mtext">Jobs</span>
                        </a>
                    </li>
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon bi bi-table"></span><span class="mtext">Orders</span>
                        </a>
                        <ul class="submenu">
                            <li><a href="allorder.html">All Orders</a></li>
                            <li><a href="datatable.html">Pending</a></li>
                            <li><a href="datatable.html">Confirm</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="pd-20 float-right">
                                    <a href="add-services.html" class="dropdown-toggle no-arrow">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="dropdown-item" href="#"><i class="dw dw-eye"></i>
                                                                View</a>
                                                            <a class="dropdown-item" href="edit-service.html"><i
