                                           ...
                                           <div class="col-md-6">
                                                <div class="form-group m-2">
                                                   ...
                                                   <input class="form-control" type="text"
                                                        placeholder="tittle"value="<?php if(!empty($tax_data['tittle'])){echo $tax_data['tittle'];}else{echo '';}?>" name="tittle" required/>
                                            ...
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>*Summary</label>
                                                    <textarea class="form-control" placeholder="Summary" name="summary" required><?php if(!empty($tax_data['summary'])){echo $tax_data['summary'];}else{echo '';}?></textarea>
  </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>*Content</label>
                                                  <textarea rows="10" cols="180" name="content" value="<?php echo (isset($tax_data['content']) ?  $tax_data['content'] : '');?>" ><?php echo (isset(
                            $tax_data['content']) ?  $tax_data['content'] : '');?>
                    </textarea></div>
                                            </div>
                                                                                          </div>
                                             <div class="row m-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>*users</label>
                                                     <select class="custom-select2 form-control"  name="user_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1">
                                                <?php 
                    if(!empty($taxlist)){
                      foreach($taxlist as $key=> $value){
                          $duration1='';
                                if($value['id'] ==  $tax_data['username'] ){
                                     $duration1= 'selected';
								}          
  ?>
      ...
      <option    value="<?php echo $value['id'];  ?>" <?php echo  $duration1; ?> <?php echo !empty($area_data['username']) && $area_data['username']==$value['username']    ?> ><?php echo $value['username']  ;?></option>
...
if (!empty($categorylist)) {
  foreach ($categorylist as $key => $value) {
    $duration1 = '';
    if ($value['id'] == $tax_data['category_name']) {
      $duration1 = 'checked';
    }
?>

<input type="checkbox" id="user_<?php echo $value['id']; ?>" name="category" value="<?php echo $value['id']; ?>" <?php echo $duration1; ?>>
<label for="user_<?php echo $value['id']; ?>"><?php echo $value['category_name']; ?></label><br>
