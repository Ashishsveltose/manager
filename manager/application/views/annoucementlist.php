                            ...
                            <div class="col-md-12">
                              <!--<div class="col-6">-->
                                <div class="pd-20 float-right">
                                    <a href="<?php echo base_url();?>addannoucement" class="dropdown-toggle no-arrow">
                                        <button type="button" class="btn btn-primary">Add Annoucement</button>
                                    </a> 
                              </div>
                              <!--   </div> -->
                        ...
                        <td>
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="javascript:void(0)" href-data="<?php echo  $getdata['id']; ?>" class="dropdown-itemm" title="Delete"><i class="dw dw-delete-3" aria-hidden="true"></i>Delete</a>
                                                                                                                                            ...
                                                                                                                                            <a style="margin-left:10px;"  href="<?php echo base_url() ?>welcome/addannoucement/<?php echo  $getdata['id']; ?>" title="Edit"><img src="<?php echo base_url();?>home/assets/vendors/images/edit.png" alt="" class="dark-logo" style="width:20px;height:20px;"/>Edit</a>
...
$(document).ready(function(){
  ...
  $(".dropdown-itemm").click(function(e){
    var val = confirm("Are you sure, you want to delete annoucement ?");
    if (val == true){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'annoucement',id:id,status:3,colwhr:'id',whrstatuscol:'status',action:"Delete"},
        dataType:'json',
