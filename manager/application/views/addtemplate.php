...
<label></label>
  <input class="form-check-input" name="template_name" type="checkbox" value="1" id="flexCheckChecked" style="height:70px;width:30px;" checked>
</div><br><br>
                                                <div class="form-group m-2">
                                                <img src="<?php echo base_url();?>upload/team/template1.png" alt="jacket" width="300" height="300">
...
<label></label>
  <input class="form-check-input" name="template_name" type="checkbox" value="1" id="flexCheckChecked" style="height:70px;width:30px;" checked>
                                                ...
                                                <div class="form-group m-2">
                                                <img src="<?php echo base_url();?>upload/team/template2.png" alt="jacket" width="300" height="300">
