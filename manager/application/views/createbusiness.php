...
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['area_name'])){echo $tax_data['area_name'];}else{echo '';}?>" name="area_name" aria-describedby="emailHelp" placeholder="Enter business area name">
                                    
    </div>
    <div class="col-md-6">
 <label for="exampleInputEmail1">Note
</label>
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['note'])){echo $tax_data['note'];}else{echo '';}?>" name="note" aria-describedby="emailHelp" placeholder="Enter note">
