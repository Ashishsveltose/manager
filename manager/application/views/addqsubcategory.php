...
<head>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        placeholder="Name"value="<?php if(!empty($tax_data['name'])){echo $tax_data['name'];}else{echo '';}?>" name="name" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>Category Name*</label>
                                          <select class="custom-select2 form-control" value="<?php if(!empty($tax_data['mcategory'])){echo $tax_data['mcategory'];}else{echo '';}?>" name="mcategory" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1">
  ...
  ?>
      ...
      <option    value="<?php echo $value['id'];  ?>" <?php echo  $duration1; ?> <?php echo !empty($area_data['category_name']) && $area_data['category_name']==$value['category_name']    ?> ><?php echo $value['category_name']  ;?></option>
                  ...
                  ?>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file"
                                                        class="form-control-file form-control height-auto"value="<?php if(!empty($tax_data['icon'])){echo $tax_data['icon'];}else{echo '';}?>" name="icon" />
                                                </div>
                                            </div>
