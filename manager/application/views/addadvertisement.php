                                        ...
                                        <div class="row m-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>Title</label>
                                                    <input class="form-control" type="text" placeholder="title" value="<?php if(!empty($tax_data['title'])){echo $tax_data['title'];}else{echo '';}?>" name="title" required/>
                                                </div>
                                            </div>
                                           <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>Content</label>
                                                    <input class="form-control" type="text" placeholder="Content" value="<?php if(!empty($tax_data['content'])){echo $tax_data['content'];}else{echo '';}?>" name="content" required/>
                                                </div>
                                            </div>
                                        </div>
                                    <div class="row m-2">
                                        <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>Image</label>
                                                    <input class="form-control" type="file" placeholder="image" value="<?php if(!empty($tax_data['image'])){echo $tax_data['image'];}else{echo '';}?>" name="image" required/>
    <?php  echo (!empty($tax_data['image'])?'<img src='.base_url().'/upload/channels/'.$tax_data['image'].' style="width:50px;height:50px">':''); ?>
                                           ...
                                           <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>Video</label>
                                                    <input class="form-control" type="file" placeholder="Video" value="<?php if(!empty($tax_data['video'])){echo $tax_data['video'];}else{echo '';}?>" name="video" />
<?php
echo (!empty($tax_data['video']) ? '<video width="50" height="50" controls><source src="' . base_url() . '/upload/channels/' . $tax_data['video'] . '" type="video/mp4">Your browser does not support the video tag.</video>' : '');
?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row m-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>Link</label>
                                                    <input class="form-control" type="text" placeholder="link" value="<?php if(!empty($tax_data['link'])){echo $tax_data['link'];}else{echo '';}?>" name="link" required/>
                                                </div>
                                            </div>
                                            </div>
