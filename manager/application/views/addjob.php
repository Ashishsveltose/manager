                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        placeholder="firstname"value="<?php if(!empty($tax_data['firstname'])){echo $tax_data['firstname'];}else{echo '';}?>" name="firstname" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    <label>Lastname</label>
                                                    <input class="form-control" type="text" placeholder="Lastname" value="<?php if(!empty($tax_data['lastname'])){echo $tax_data['lastname'];}else{echo '';}?>" name="lastname"/>
                                                </div>
                                            </div>
                                        </div>
                                      <div class="row m-2">
                                      <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                                ...
                                                <div class="form-group m-2">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        placeholder="mobile number"value="<?php if(!empty($tax_data['mobile_no'])){echo $tax_data['mobile_no'];}else{echo '';}?>" name="mobile_no" />
                                                </div>
                                            </div>
                                     </div>
                                       <div class="row m-2">
