                ...
                <div class="min-height-200px">
                    <div class="card-box mb-30">
                        <div class="row">
                            <div class="col-6">
                                <div class="pd-20">
                                    <h4 class="text-blue h4">Area List</h4>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="pd-20 float-right">
                                    <a href="https://edumatelive.in/newadmin/addarea" class="dropdown-toggle no-arrow">
...
$(document).ready(function(){
  ...
  $(".dropdown-item").click(function(e){
    var val = confirm("Are you sure, you want to delete Area ?");
    if (val == true){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'area',id:id,status:3,colwhr:'id',whrstatuscol:'status',action:"Delete"},
        dataType:'json',
