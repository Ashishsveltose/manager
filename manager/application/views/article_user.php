                                    ...
                                    <form role="form" enctype="multipart/form-data" method="post" action="">
                                           ...
                                           <div class="col-md-6">
                                                <div class="form-group m-2">
                                                   ...
                                                   <input class="form-control" type="text"
                                                        placeholder="Username"value="<?php if(!empty($tax_data['username'])){echo $tax_data['username'];}else{echo '';}?>" name="username" required/>
                                           ...
                                           <div class="col-md-6">
                                                <div class="form-group m-2">
                                                   ...
                                                   <input class="form-control" type="text"
                                                        placeholder="Password"value="<?php if(!empty($tax_data['password'])){echo $tax_data['password'];}else{echo '';}?>" name="password" required/>
