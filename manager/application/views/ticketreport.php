...
<td>
  <a href="https://chauffit.com/manager/welcome/replyview/<?php echo htmlspecialchars($getdata['id']); ?>" >
    <svg xmlns="http://www.w3.org/2000/svg" width="25" color="green" height="25" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
