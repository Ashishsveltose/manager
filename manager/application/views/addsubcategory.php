                                        ...
                                        <div class="row m-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group m-2">
                                                   ...
                                                   <select class="custom-select2 form-control" value="<?php if(!empty($tax_data['cat_id'])){echo $tax_data['cat_id'];}else{echo '';}?>" name="cat_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1">
                                           ...
                                           <div class="col-md-6">
                                                <div class="form-group m-2">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        placeholder="category name"value="<?php if(!empty($tax_data['subcat_name'])){echo $tax_data['subcat_name'];}else{echo '';}?>" name="subcat_name" />
                                                </div>
                                            </div>
                                             </div>
